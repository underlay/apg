...
export declare function validateMapping([M1, M2]: APG.Mapping, S: APG.Schema, T: APG.Schema): boolean;
export declare function fold(M1: readonly APG.Path[], T: APG.Schema, type: APG.Type): APG.Type;
