...
// Do NOT edit this file at *all* unless you absolutely know what you are doing.
// Do not edit this file unless you are Joel Gustafson.
...
const anyValue = Object.freeze({
  type: "coproduct",
  options: [valueOptionCoproduct, valueOptionIri, valueOptionLiteral, valueOptionProduct, valueOptionReference, valueOptionUnit]
});
Object.freeze(anyValue.options); // Component (index 0)

const componentComponentKeyValue = Object.freeze({
  type: "iri"
});
...
const componentValue = Object.freeze({
  type: "product",
  components: [componentComponentKey, componentComponentSource, componentComponentValue]
});
...
const coproductValue = Object.freeze({
  type: "unit"
});
...
const labelComponentKeyValue = Object.freeze({
  type: "iri"
});
...
const literalComponentDatatypeValue = Object.freeze({
  type: "iri"
});
...
const optionComponentKeyValue = Object.freeze({
  type: "iri"
});
...
const productValue = Object.freeze({
  type: "unit"
});
...
const schemaSchema = [componentLabel, coproductLabel, iriLabel, labelLabel, literalLabel, optionLabel, productLabel, referenceLabel, unitLabel];
