...
exports.default = exports.type = exports.coproduct = exports.product = exports.literal = exports.uri = exports.unit = exports.reference = void 0;
...
const type = t.recursion("Type", () => t.union([reference, unit, uri, literal, product, coproduct]));
exports.type = type;
...
const codec = new t.Type("Schema", labels.is, (input, context) => {
  ...
  for (const [_, label] of (0, _utils.getEntries)(result.right)) {
