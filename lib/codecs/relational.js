...
const isOptionalProperty = type => isProperty(type) || type.type === "coproduct" && (0, _utils.getKeys)(type).length === 2 && ns.none in type.options && (0, _unit.isUnit)(type.options[ns.none]) && ns.some in type.options && isProperty(type.options[ns.some]);
