...
const elementComponentKeyValue = Object.freeze({
  type: "iri"
});
...
const elementValueComponents = [elementComponentKey, elementComponentSource, elementComponentValue];
...
const expressionOptionId = Object.freeze({
  type: "iri"
}); // 2.2 injection
...
const expressionOptionNode = Object.freeze({
  type: "unit"
}); // 2.4 path
...
const expressionOptions = [{
  ...
  type: "option",
  key: ns.node,
  value: expressionOptionNode
}, {
  type: "option",
  key: ns.path,
  value: expressionOptionPath
}, {
  type: "option",
  key: ns.tuple,
...
const expressionSchema = [caseLabel, elementLabel, expressionLabel, matchLabel, pathLabel, tupleLabel];
Object.freeze(expressionSchema);
var _default = expressionSchema;
