...
Object.defineProperty(exports, "expressionSchema", {
  enumerable: true,
  get: function () {
...
var _expression = _interopRequireDefault(require("./schemas/expression.js"));
...
Object.keys(_schema2).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _schema2[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _schema2[key];
