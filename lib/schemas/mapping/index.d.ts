...
declare const mappingSchema: Readonly<{
    ...
    "http://underlay.org/ns/expression": APG.Coproduct<{
        "http://underlay.org/ns/none": APG.Product<{}>;
        "http://underlay.org/ns/some": APG.Product<{
            "http://underlay.org/ns/head": APG.Coproduct<{
            ...
            "http://underlay.org/ns/tail": APG.Reference<"http://underlay.org/ns/expression">;
        }>;
    }>;
