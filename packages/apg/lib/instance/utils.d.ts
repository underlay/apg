...
export declare function forValues<S extends Record<string, Schema.Type>>(schema: Schema.Schema<S>, instance: Instance.Instance<S>, key: string, path: string[]): Generator<Instance.Value, void, undefined>;
