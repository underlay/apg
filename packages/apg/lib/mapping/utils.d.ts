...
export declare const mapExpressions: (expressions: readonly Mapping.Expression[], value: Instance.Value, instance: Instance.Instance, schema: Schema.Schema) => Instance.Uri<string> | Instance.Literal<string> | Instance.Product<{
