...
import { delta, Mapping, fold, map } from "./mapping.js"
import { getId } from "./utils.js"

function getMigrationTestSchemas(): [APG.Schema, APG.Schema] {
	const S: APG.Schema = [
		{
			type: "label",
...
function getMigrationMapping(): Mapping {
	const paths: APG.Path[] = [
		[0, NaN],
		[1, NaN],
	]
	const morphisms: APG.Morphism[] = [
		{
			type: "tuple",
